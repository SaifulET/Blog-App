...
const AddService = () => {
  ...
  return (
    <div className="dflex">
      <Sticky>
        <AdminNavbar name="Services" />
      </Sticky>
      <div className="addUser">
        <Link to="/serviceAll" className="btn btn-secondary back-btn">
        ...
        <form className="addUserForm" onSubmit={handleSubmit}>
          ...
          <div className="InputGroup">
            ...
            <button type="button" className="btn btn-outline-primary" onClick={openBootstrapIcons}>
              Choose an Icon
            </button>
            <input
              type="text"
